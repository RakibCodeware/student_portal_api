...
public partial class ExamInfo
{
    ...
    public virtual ICollection<ExamDependencyInfo> ExamDependencyInfos { get; } = new List<ExamDependencyInfo>();

    public virtual ICollection<ExamResultSheet> ExamResultSheets { get; } = new List<ExamResultSheet>();
}
